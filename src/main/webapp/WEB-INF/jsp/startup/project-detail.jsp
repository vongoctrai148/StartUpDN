                    ...
                    <div class="post-content post-single">
                        ...
                        <div class="post-body">
                            <div class="entry-header">
                                ...
                                <h4 style=" color: orange">Số vốn kêu gọi: ${project.amountcalled} VNĐ</h4>
                                <blockquote>
                            ...
                            <div id="page-slider" class="page-slider">
                                <c:forEach items="${imageOfProject}" var="image">
                                    <div class="item">
                                        <img loading="lazy" class="img-fluid" src="/images/projectImages/${image.imagename}" alt="project-slider-image" />
                                    </div>
                                </c:forEach>
                            </div><!-- Page slider end -->
                                    ...
                                    <div class="comment-body">
                                        ...
                                        <div class="comment-content">
                                            <p>
                                                ...
                                                laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehen.
                                            </p>
                                        </div>
                                        <div class="text-left">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-4 col-md-6 footer-widget mt-5 mt-md-0">
                        ...
                        <div class="working-hours">
                            ...
                            <br />
                            <br />
                            Monday - Friday: <span class="text-right">10:00 - 16:00 </span> <br />
                            Saturday: <span class="text-right">12:00 - 15:00</span> <br />
                            Sunday and holidays: <span class="text-right">09:00 - 12:00</span>
                        </div>
                    </div>
                    <!-- Col end -->
